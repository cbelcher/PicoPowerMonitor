        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                if (match.Success)
                {
                    ...
                    // Remove the "V A and P" labels, we all know what units they are.
            ...
            // New catch exception to deal with any communication issues.
            // catch { /* Ignore malformed packets during streaming */ }
            catch (Exception ex)
            {
                // If the cable is bumped or the line is mangled, we catch it here.
                // We use TryEnqueue so we don't block the serial thread with UI updates.
                DispatcherQueue.TryEnqueue(() =>
                {
                    StatusText.Text = "Stream Error: Check Connection";
